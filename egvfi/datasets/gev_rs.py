...
def get_1x_frame_interpolate_1_frame(
    root,
...
def get_2x_frame_interpolate_3_frame(
    root,
    center_cropped_height,
    random_cropped_width,
    sample_step,
...
def get_4x_frame_interpolate_5_frame(
    root,
    center_cropped_height,
    random_cropped_width,
    sample_step,
...
def get_8x_frame_interpolate_9_frame(
    root,
    center_cropped_height,
    random_cropped_width,
    sample_step,
...
def get_12x_frame_interpolate_13_frame(
    root,
    center_cropped_height,
    random_cropped_width,
    sample_step,
...
def get_16x_frame_interpolate_17_frame(
    root,
    center_cropped_height,
    random_cropped_width,
    sample_step,
...
def get_24x_frame_interpolate_25_frame(
    root,
    center_cropped_height,
    random_cropped_width,
    sample_step,
...
def get_32x_frame_interpolate_33_frame(
    root,
    center_cropped_height,
    random_cropped_width,
    sample_step,
...
def get_128x_frame_interpolate_33_frame(
...
def get_gev_rs_dataset(
    ...
    train = GevRSEventHighSpeedVideoSimulatedDataset(
        root=root,
        item_samples=item_samples,
        input_rs_frame_indexes=input_rs_frame_indexes,
        input_rs_frame_timestamps=input_rs_frame_timestamps,
    ...
    test = GevRSEventHighSpeedVideoSimulatedDataset(
        root=root,
        item_samples=item_samples,
        input_rs_frame_indexes=input_rs_frame_indexes,
        input_rs_frame_timestamps=input_rs_frame_timestamps,
...
class GevRSEventHighSpeedVideoSimulatedDataset(Dataset):
    def __init__(
        self,
        root,
        item_samples,
        ...
        """
        super(GevRSEventHighSpeedVideoSimulatedDataset, self).__init__()
        # assert
    ...
    def _walk(self):
        ...
        assert len(frame_folders) == (len(TEST_VIDEO_NAMES) + len(TRAIN_VIDEO_NAMES))

        items = []
        for frame_folder, event_folder, rolling_folder in zip(frame_folders, event_folders, rolling_folders):
            assert frame_folder[:10] == event_folder[:10] == rolling_folder[:10]
            video_name = frame_folder[:10]
